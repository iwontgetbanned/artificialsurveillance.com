        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/products" className="text-accent-silver hover:text-primary transition-colors text-sm">
                  Products
                </Link>
              </li>
              <li>
                <Link to="/industries" className="text-accent-silver hover:text-primary transition-colors text-sm">
                  Industries
                </Link>
              </li>
              <li>
